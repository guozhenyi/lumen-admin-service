...
class Param
{
     ...
     * @return string
     */
    public static function getMobile(array $aryDict, $default = null)
    {
     ...
     * @return string
     */
    public static function getSmsCode(array $aryDict, $default = null)
    {
     ...
     * @return int|null
     */
    public static function getPage(array $aryDict, $default = null)
    {
        $value = 0;
     ...
     * @return int|null
     */
    public static function getPageSize(array $aryDict, $default = null)
    {
        $value = 0;
     ...
     * @return int|null
     */
    public static function getLimit(array $aryDict, $default = null)
    {
     ...
     * @return int|null
     */
    public static function getCurId(array $aryDict, $default = null)
    {
     ...
     * @return int|null
     */
    public static function getCurMaxId(array $aryDict, $default = null)
    {
     ...
     * @return int|null
     */
    public static function getCurMinId(array $aryDict, $default = null)
    {
     ...
     * @return string|null
     */
    public static function getOrder(array $aryDict, $default = null)
    {
     ...
     * @return int|null
     */
    public static function getAction(array $aryDict, $default = null)
    {
     ...
     * @return int|null
     */
    public static function getType(array $aryDict, $default = null)
    {
